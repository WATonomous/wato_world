"""Command-line entrypoint for student_training."""

from __future__ import annotations

import click

from wato_student_training.config import load_config
from wato_student_training.pipeline import run as run_pipeline


@click.group()
def main() -> None:
    """Self-trained student detector (BEVFusion / TransFusion)."""
